			...
			<td align="center" valign="top">
				<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#F5F5F5" class="bg_qc">
					<tr>
						<td width="25" height="20" align="center"><img src="themes/nzblue/images/nzcms.xinxin.gif" alt="标" width="9"
							height="9" /></td>
						<td align="left" class="p12">您的位置： <a href="index.jsp">首页</a>&nbsp;&gt;&nbsp;&nbsp;提交简历
						</td>
					</tr>
				</table>
				...
				<form action="index/addApplys.action" name="myform" method="post">
					<table width="46%" border="0" cellpadding="5" cellspacing="1" bgcolor="#E0EDB7">
						<tr>
							<td height="30" colspan="2" align="center" background="themes/nzblue/images/nzcms/list_bg.gif" class="white14B">提交简历</td>
						</tr>
						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">求职单号：</td>
							<td bgcolor="#FFFFFF">${ano }<input type="hidden" name="ano" id="ano" value="${ano }" readonly="readonly" /></td>
						</tr>
						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">职位：</td>
							<td bgcolor="#FFFFFF">${jobs.title } <input type="hidden" name="jobsid" id="jobsid" value="${jobs.jobsid }"
								readonly="readonly" /></td>
						</tr>
						<tr>
							<td height="50" align="right" bgcolor="#FFFFFF">文件：</td>
							<td bgcolor="#FFFFFF"><input type="text" style="width: 260px; height: 30px" name="filurl" id="image"
								onclick="selimage();" placeholder="请选择文件" readonly="readonly" /></td>
						</tr>
						<tr>
